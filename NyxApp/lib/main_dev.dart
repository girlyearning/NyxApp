...
void main() async {
  ...
  LoggingService.logInfo('🚀 Nyx App starting (DEV MODE)...');
  
  // No environment variables needed - all API calls routed through backend
  LoggingService.logInfo('✅ Development mode - backend API routing configured');
  
  // No client-side API keys - all Claude calls go through backend
  LoggingService.logInfo('✅ App initialized - API calls routed through backend');
