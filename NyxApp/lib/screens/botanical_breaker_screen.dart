...
class _BotanicalBreakerScreenState extends State<BotanicalBreakerScreen>
  ...
  String gameState = 'menu'; // 'menu', 'playing', 'victory', 'gameOver'
  ...
  void _checkBallWallCollision() {
    ...
    // Bottom wall - game over if ball touches ground
  ...
  void _endGame({bool victory = false}) {
    ...
    if (victory) {
      ...
      _awardPoints(); // Award partial points even on game over
    }
  }
